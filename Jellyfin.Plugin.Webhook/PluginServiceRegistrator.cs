...
using Jellyfin.Plugin.Webhook.Notifiers.ItemRemovedNotifier;
...
public class PluginServiceRegistrator : IPluginServiceRegistrator
{
    ...
    public void RegisterServices(IServiceCollection serviceCollection, IServerApplicationHost applicationHost)
    {
        ...
        serviceCollection.AddSingleton<IItemRemovedManager, ItemRemovedManager>();
        // Security consumers.
        ...
        serviceCollection.AddHostedService<ItemRemovedNotifierEntryPoint>();
    }
}
